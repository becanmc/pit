...
if(isset($_POST["reset-request-submit"])) {
    ...
    $message = '<p> Recebemos uma solicitação para alterar sua senha. O link para redefinir sua senha está abaixo, se você não solicitou isso pode ignorar este email </p>';
    ...
    if (!$mail->send()) {
        ...
        echo 'E-mail enviado com sucesso para ' . $userEmail;
